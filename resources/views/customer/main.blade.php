...
<script>
    ...
    function form_save() {
        $('.forms-customer').submit(function(e){
            e.preventDefault()
    ...
    function form_data(id=nul,action='edit') {
        ...
        $('.preload-page').show()
        if(action == 'edit'){
            $.get("{{ route('getDataCustomer') }}",{id:id})
            .done(function(result){
                if(result.status == 'success'){
                    ...
                    $('#form-title').text('Edit Data Customer')
                    $('.forms-customer form-control').removeAttr('disabled')
            ...
            $.get("{{ route('formContentCustomer') }}")
            .done(function(result){
                $('.preload-page').hide()
                $('.other-page').show()
                $('.other-page').html(result.content)
                $('#form-title').text('Tambah Data Customer')
                $('.forms-customer form-control').removeAttr('disabled')
                reset_form()
            ...
            .done(function(result){
                if(result.status == 'success'){
                    ...
                    $('.other-page').show()
                    $('.other-page').html(result.content)
                    $('#form-title').text('Detail Data Customer')
                    $('.forms-customer .form-control').prop('disabled',true)
                    $('.btn-simpan').hide()
