...
<script>
    ...
    function form_save() {
        $('.forms-supplier').submit(function(e){
            e.preventDefault()
            var data = $(this).serialize();
            $.ajax({
                type: "post",
                url: "{{ route('saveSupplier') }}",
                data: data,
                dataType: "json",
    ...
    function form_data(id=nul,action='edit') {
        ...
        $('.preload-page').show()
        if(action == 'edit'){
            $.get("{{ route('getDataSupplier') }}",{id:id})
            .done(function(result){
                if(result.status == 'success'){
                    ...
                    $('#form-title').text('Edit Data Supplier')
                    $('.forms-supplier form-control').removeAttr('disabled')
            ...
            $.get("{{ route('formContentSupplier') }}")
            .done(function(result){
                $('.preload-page').hide()
                $('.other-page').show()
                $('.other-page').html(result.content)
                $('#form-title').text('Tambah Data Supplier')
                $('.forms-supplier form-control').removeAttr('disabled')
                reset_form()
            ...
            .done(function(result){
                if(result.status == 'success'){
                    ...
                    $('.other-page').show()
                    $('.other-page').html(result.content)
                    $('#form-title').text('Detail Data Supplier')
                    $('.forms-supplier .form-control').prop('disabled',true)
                    $('.btn-simpan').hide()
